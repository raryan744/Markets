...
**Generated:** 2026-03-20 20:35:48 UTC
...
runner       1  3.0  0.1 1269472 42624 ?       Ssl  20:35   0:00 /usr/local/bin/pid1
runner      27  0.0  0.0   7636  3840 ?        S    20:35   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      28 28.7  0.4 1005724 141804 ?      Sl   20:35   0:02 python3 background_runner.py
runner      29 29.4  0.2 462500 82556 ?        Sl   20:35   0:02 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      55 28.5  0.0  11172  4608 ?        R    20:35   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 541919 rows
  book_image_snapshots: 2666 rows
  brti_ticks: 279053 rows
  btc_prices: 9317 rows
  ensemble_predictions: 288239 rows
  kalshi_candlesticks: 2062 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 108213 rows
  paper_trader_log: 0 rows
  training_samples: 183645 rows
  xgb_mtf_predictions: 1742 rows
...
*Auto-generated by github_auto_push.py at 2026-03-20 20:35:48 UTC*
