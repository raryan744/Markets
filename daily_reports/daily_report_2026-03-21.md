...
**Generated:** 2026-03-21 13:59:02 UTC
...
runner       1  4.2  0.1 1269728 42624 ?       Ssl  13:58   0:00 /usr/local/bin/pid1
runner      26  0.0  0.0   7636  3456 ?        S    13:58   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      28 34.1  0.4 974008 142604 ?       Sl   13:58   0:03 python3 background_runner.py
runner      29 34.9  0.2 461476 82704 ?        Sl   13:58   0:03 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      56 23.0  0.0  11172  4864 ?        R    13:59   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 584579 rows
  book_image_snapshots: 3477 rows
  brti_ticks: 332443 rows
  btc_prices: 10361 rows
  ensemble_predictions: 306659 rows
  kalshi_candlesticks: 2104 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 90257 rows
  paper_trader_log: 576 rows
  training_samples: 199151 rows
  xgb_mtf_predictions: 3598 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 13:59:02 UTC*
