...
**Generated:** 2026-03-21 15:22:34 UTC
...
runner       1  4.0  0.1 1270100 42240 ?       Ssl  15:22   0:00 /usr/local/bin/pid1
runner      25  0.0  0.0   7636  3840 ?        S    15:22   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      28 30.6  0.4 972980 141276 ?       Sl   15:22   0:03 python3 background_runner.py
runner      29 34.6  0.2 461700 83052 ?        Rl   15:22   0:04 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      56 33.3  0.0  11172  4736 ?        R    15:22   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 586799 rows
  book_image_snapshots: 3524 rows
  brti_ticks: 336227 rows
  btc_prices: 10444 rows
  ensemble_predictions: 307079 rows
  kalshi_candlesticks: 2110 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 87867 rows
  paper_trader_log: 607 rows
  training_samples: 199182 rows
  xgb_mtf_predictions: 3644 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 15:22:34 UTC*
