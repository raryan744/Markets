...
**Generated:** 2026-03-21 12:50:43 UTC
...
runner       1  3.6  0.1 1269984 41728 ?       Ssl  12:50   0:00 /usr/local/bin/pid1
runner      28  0.0  0.0   7636  3840 ?        S    12:50   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      29 27.6  0.4 972976 138964 ?       Sl   12:50   0:03 python3 background_runner.py
runner      30 32.3  0.2 461700 83036 ?        Rl   12:50   0:04 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      57 40.0  0.0  11172  4608 ?        R    12:50   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 582839 rows
  book_image_snapshots: 3433 rows
  brti_ticks: 329244 rows
  btc_prices: 10292 rows
  ensemble_predictions: 306359 rows
  kalshi_candlesticks: 2101 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 92776 rows
  paper_trader_log: 528 rows
  training_samples: 199116 rows
  xgb_mtf_predictions: 3570 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 12:50:43 UTC*
