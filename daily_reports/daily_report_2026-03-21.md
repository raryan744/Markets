...
**Generated:** 2026-03-21 07:37:21 UTC
...
runner       1  4.6  0.1 1270264 41856 ?       Ssl  07:37   0:00 /usr/local/bin/pid1
runner      30  0.0  0.0   7636  3840 ?        S    07:37   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      31 37.1  0.4 972976 141568 ?       Sl   07:37   0:03 python3 background_runner.py
runner      32 38.8  0.2 462176 82244 ?        Sl   07:37   0:04 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      59 27.2  0.0  11172  4480 ?        R    07:37   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  brti_ticks: 315854 rows
  btc_prices: 9979 rows
  ensemble_predictions: 305159 rows
  kalshi_candlesticks: 2086 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 92072 rows
  paper_trader_log: 381 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 07:37:21 UTC*
