...
**Generated:** 2026-03-21 14:48:24 UTC
...
runner       1  5.2  0.1 1270404 42112 ?       Ssl  14:48   0:00 /usr/local/bin/pid1
runner      31  0.0  0.0   7636  3968 ?        S    14:48   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      32 33.1  0.4 972980 142160 ?       Sl   14:48   0:03 python3 background_runner.py
runner      33 36.9  0.2 462176 82256 ?        Dl   14:48   0:04 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      59 33.3  0.0  11172  4608 ?        R    14:48   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 585659 rows
  book_image_snapshots: 3501 rows
  brti_ticks: 334720 rows
  btc_prices: 10410 rows
  ensemble_predictions: 306839 rows
  kalshi_candlesticks: 2107 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 89215 rows
  paper_trader_log: 594 rows
  training_samples: 199157 rows
  xgb_mtf_predictions: 3617 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 14:48:24 UTC*
