# Daily Evidence Report — 2026-03-21

**Generated:** 2026-03-21 20:43:55 UTC
...
runner         1  0.0  0.0 2602972 57520 ?       Ssl  20:03   0:00 /nix/store/f44v4qidsnm4323dwjcq9q0rxahh1pvb-pid1-0.0.1/bin/pid1 --pid2-pooling
runner        15  0.2  0.8 23411384 557844 ?     Sl   20:03   0:05 pid2 --no-deprecation --disable-warning=ExperimentalWarning --use-openssl-ca /pid2/bundles/0.0.3858/server.cjs --start-timestamp=1774123401430 --socket-listener-fd=3 --pinger-socket-path=/run/replit/socks/pid2ping.0.sock --pooled-fd=4
runner        46  0.0  0.0   3984  2892 ?        S    20:43   0:00 nix-editor --return-output
runner        83  0.0  0.0   2960  2036 ?        S    20:43   0:00 sh -c /nix/store/qq4mijbp008lc0r1h42jy3fhwakqz6nf-taplo-0.patched/bin/taplo lsp -c /nix/store/7nplpw32gfk08i6d1v3wmwj3b1qd0apw-taplo-config.toml stdio
runner        84  0.3  0.0 843252 28492 ?        Sl   20:43   0:00 /nix/store/qq4mijbp008lc0r1h42jy3fhwakqz6nf-taplo-0.patched/bin/taplo lsp -c /nix/store/7nplpw32gfk08i6d1v3wmwj3b1qd0apw-taplo-config.toml stdio
runner        85  0.0  0.0   2960  2140 ?        S    20:43   0:00 sh -c /nix/store/775cppcslcvxd4x2v8x4k78xw94zg88a-ty-0.0.21/bin/ty server
runner        92  0.0  0.0 1297688 20128 ?       Sl   20:43   0:00 /nix/store/775cppcslcvxd4x2v8x4k78xw94zg88a-ty-0.0.21/bin/ty server
runner       224  1.5  0.0   8256  4952 pts/0    Ss   20:43   0:00 /nix/store/smkzrg2vvp3lng3hq7v9svfni5mnqjh2-bash-interactive-5.2p37/bin/bash -rcfile /nix/store/lsgsb0ar7rdwa09d1z2dnfjh4188pddk-replit-bashrc/bashrc --rcfile /nix/store/lsgsb0ar7rdwa09d1z2dnfjh4188pddk-replit-bashrc/bashrc -ci python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner       231  152  0.2 884828 132252 pts/0   Sl   20:43   0:00 python3 background_runner.py
runner       232 88.1  0.1 110600 99616 pts/0    R+   20:43   0:00 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner       250  0.0  0.0  11336  5100 pts/0    R    20:43   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 1722112 rows
  book_image_snapshots: 4069 rows
  brti_ticks: 286621 rows
  btc_prices: 13682 rows
  ensemble_predictions: 615297 rows
  kalshi_candlesticks: 2601 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 35364 rows
  paper_trader_log: 90 rows
  training_samples: 1645604 rows
  xgb_mtf_predictions: 17360 rows
...
```
  ...
  REPLIT_DB_URL=https://kv.replit.com/v0/eyJhbGciOiJIUzUxMiIsImlzcyI6ImNvbm1hbiIsImtpZCI6InByb2Q6MSIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJjb25tYW4iLCJleHAiOjE3NzQyMzc0MTMsImlhdCI6MTc3NDEyNTgxMywiZGF0YWJhc2VfaWQiOiI1ZjkwNDYxNi1kMTA4LTQ4Y2ItYjdiNy0wMWI2MjgyMzUzYmYifQ.Ei90KFHkPbLam_DDz2MNhJ_VPkaesWx4GRR-SfrK8TxgtxT8UQ1OUNkXRbBG_-nY8bc92ysGlDT056UIWc1l8w
...
```
  ...
  auto_trade_settings.json: 259 bytes, modified 2026-03-21 00:54:21
  ...
  brti_cnn_lstm.pth: 2,314,039 bytes, modified 2026-03-21 01:02:12
  brti_cnn_lstm_10m.pth: 2,314,127 bytes, modified 2026-03-21 01:01:55
  brti_xgboost.pkl: 974,906 bytes, modified 2026-03-21 01:02:08
  brti_xgboost_15s.pkl: 128,033 bytes, modified 2026-03-21 01:01:55
  brti_xgboost_60s.pkl: 183,416 bytes, modified 2026-03-21 01:01:57
  ...
  daily_report_2026-03-21.md: 18,160 bytes, modified 2026-03-21 20:43:53
  github_auto_push.py: 10,138 bytes, modified 2026-03-20 07:38:33
  github_push_log.json: 37,567 bytes, modified 2026-03-20 23:48:03
...
Total pushes to date: 26
Last push: 2026-03-20 23:47:38 UTC

- 2026-03-20 20:51:41 UTC: 6 pushed, 0 failed
- 2026-03-20 21:22:56 UTC: 6 pushed, 0 failed
...
*Auto-generated by github_auto_push.py at 2026-03-21 20:43:55 UTC*
