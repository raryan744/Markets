...
**Generated:** 2026-03-21 07:10:26 UTC
...
runner       1  4.7  0.1 1269588 41728 ?       Ssl  07:10   0:00 /usr/local/bin/pid1
runner      26  0.0  0.0   7636  3968 ?        S    07:10   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      27 36.1  0.4 972984 141480 ?       Sl   07:10   0:03 python3 background_runner.py
runner      28 41.8  0.2 462400 82552 ?        Rl   07:10   0:04 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      55 50.0  0.0  11172  4608 ?        R    07:10   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 578339 rows
  book_image_snapshots: 3326 rows
  brti_ticks: 314348 rows
  btc_prices: 9952 rows
  ensemble_predictions: 305159 rows
  kalshi_candlesticks: 2085 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 91580 rows
  paper_trader_log: 359 rows
  training_samples: 199093 rows
  xgb_mtf_predictions: 3437 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 07:10:26 UTC*
