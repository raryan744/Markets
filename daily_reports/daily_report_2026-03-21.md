...
**Generated:** 2026-03-21 08:58:58 UTC
...
runner       1  4.5  0.1 1270008 41856 ?       Ssl  08:58   0:00 /usr/local/bin/pid1
runner      29  0.0  0.0   7636  3840 ?        S    08:58   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      30 32.6  0.4 974136 141988 ?       Sl   08:58   0:03 python3 background_runner.py
runner      31 34.8  0.2 475608 96656 ?        Sl   08:58   0:04 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      57 36.3  0.0  11172  4864 ?        R    08:58   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 578699 rows
  book_image_snapshots: 3328 rows
  brti_ticks: 318499 rows
  btc_prices: 10060 rows
  ensemble_predictions: 305159 rows
  kalshi_candlesticks: 2087 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 90902 rows
  paper_trader_log: 408 rows
  training_samples: 199093 rows
  xgb_mtf_predictions: 3439 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 08:58:58 UTC*
