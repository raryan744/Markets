...
**Generated:** 2026-03-21 16:01:29 UTC
...
runner       1  5.2  0.1 1269728 43136 ?       Ssl  16:01   0:00 /usr/local/bin/pid1
runner      28  0.0  0.0   7636  3840 ?        S    16:01   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      29 36.4  0.4 974008 143584 ?       Sl   16:01   0:04 python3 background_runner.py
runner      30 47.7  0.2 462176 82416 ?        Sl   16:01   0:05 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      56 20.8  0.0  11172  4352 ?        R    16:01   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 587279 rows
  book_image_snapshots: 3535 rows
  brti_ticks: 338157 rows
  btc_prices: 10483 rows
  ensemble_predictions: 307199 rows
  kalshi_candlesticks: 2111 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 88517 rows
  paper_trader_log: 630 rows
  training_samples: 199189 rows
  xgb_mtf_predictions: 3657 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 16:01:29 UTC*
