...
**Generated:** 2026-03-21 05:07:26 UTC
...
runner       1  5.2  0.1 1270148 42624 ?       Ssl  05:07   0:00 /usr/local/bin/pid1
runner      31  0.0  0.0   7636  3840 ?        S    05:07   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      32 36.2  0.4 972976 141908 ?       Sl   05:07   0:04 python3 background_runner.py
runner      33 41.0  0.2 462176 82400 ?        Sl   05:07   0:04 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      59 16.6  0.0  11172  4736 ?        R    05:07   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 575279 rows
  book_image_snapshots: 3247 rows
  brti_ticks: 307678 rows
  btc_prices: 9829 rows
  ensemble_predictions: 304199 rows
  kalshi_candlesticks: 2074 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 91093 rows
  paper_trader_log: 292 rows
  training_samples: 198255 rows
  xgb_mtf_predictions: 3332 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 05:07:26 UTC*
