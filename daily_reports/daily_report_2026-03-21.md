...
**Generated:** 2026-03-21 11:06:25 UTC
...
runner       1  3.5  0.1 1269472 41600 ?       Ssl  11:06   0:00 /usr/local/bin/pid1
runner      27  0.0  0.0   7636  3968 ?        S    11:06   0:00 bash -c python3 background_runner.py & streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      28 31.7  0.4 972980 142040 ?       Sl   11:06   0:03 python3 background_runner.py
runner      29 31.4  0.2 461476 82600 ?        Sl   11:06   0:03 /nix/store/flbj8bq2vznkcwss7sm0ky8rd0k6kar7-python-wrapped-0.1.0/bin/python3 /home/runner/workspace/.pythonlibs/bin/streamlit run app.py --server.port 5000 --server.enableCORS false --server.enableXsrfProtection false
runner      55 25.0  0.0  11172  4608 ?        R    11:06   0:00 ps aux
...
Tables: auto_trades, bobby_brti_ticks, book_image_snapshots, brti_ticks, btc_prices, ensemble_predictions, kalshi_candlesticks, kalshi_depth_signal, kalshi_orderbook, paper_trader_log, training_samples, xgb_mtf_predictions
  ...
  bobby_brti_ticks: 580859 rows
  book_image_snapshots: 3381 rows
  brti_ticks: 324142 rows
  btc_prices: 10185 rows
  ensemble_predictions: 305639 rows
  kalshi_candlesticks: 2098 rows
  kalshi_depth_signal: 0 rows
  kalshi_orderbook: 92030 rows
  paper_trader_log: 463 rows
  training_samples: 199104 rows
  xgb_mtf_predictions: 3492 rows
...
*Auto-generated by github_auto_push.py at 2026-03-21 11:06:25 UTC*
